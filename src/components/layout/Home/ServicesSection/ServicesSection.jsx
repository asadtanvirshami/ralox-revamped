...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      mode: "dark",
      description:
        "In the domain of blockchain development, we specialize in harnessing the power of distributed ledger technology to build transparent, secure, and decentralized solutions. Our approach involves designing and implementing blockchain networks that ensure data integrity, immutability, and trust. From smart contract development to consensus mechanisms, our expert team navigates the intricacies of blockchain technology to deliver solutions that revolutionize industries and empower businesses with enhanced security and efficiency. Trust us to bring your blockchain ideas to life with cutting-edge development and a focus on innovation.",
      animation: "fade-up-left",
    },
    {
      icon: <HiBadgeCheck fontSize={35} color="white" className="mr-2" />,
      ...
      mode: "dark",
      description:
        "In the realm of IoT (Internet of Things) development, we leverage cutting-edge technologies to create interconnected systems that enhance efficiency and enable smart automation. Our approach involves designing scalable and secure IoT solutions tailored to your specific requirements. From sensor integration to data analytics, our expert team navigates the complexities of IoT development to deliver innovative solutions that optimize processes and drive business growth.",
      animation: "fade-up-left",
    },
  ];
  ...
  return (
    <div
      data-aos={"fade-up"}
      className="w-full container  flex flex-wrap justify-center"
    >
