...
const ServiceCard = ({ icon, title, mode, description, animation }) => (
...
const ServicesSection = () => {
  const services = [
    {
      icon: <RiCodeSSlashFill fontSize={35} color="white" className="mr-2" />,
    ...
    },
    {
      ...
      mode: 'dark',
      description: 'In the field of Quality Assurance (Q/A), we excel in upholding the highest standards throughout the software development lifecycle. Our meticulous approach involves thorough testing and validation, guaranteeing the reliability and performance of your applications. With a dedicated team of QA experts, we ensure that every facet of your software meets stringent quality benchmarks, fostering confidence in the seamless functionality of your products. Rely on us for comprehensive Quality Assurance solutions that elevate the overall reliability and performance of your software.',
      animation: 'fade-up-left',
    },
    {
      icon: <RiCodeSSlashFill fontSize={35} color="white" className="mr-2" />,
    ...
    },
    {
      ...
      mode: 'dark',
      description: 'As a holistic digital marketing service, we meticulously document strategies for PPC, SEO, content writing, and social media management, including Meta Business Suite. Our commitment to knowledge sharing fosters continuous learning, ensuring transparency and client success across these pivotal domains.',
      animation: 'fade-up-left',
    },
  ];

  return (
    <div data-aos={'fade-up'} className="w-full container  flex flex-wrap justify-center">
    <h1 className="text-3xl text-center lg:text-[3rem] font-bold mt-8 mb-12 text-slate-300 w-full">
