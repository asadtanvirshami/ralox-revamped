...
const Contact = () => {
  return (
    <div className="bg-white w-full h-screen">
      <h1 className=" bg-black text-center font-semibold pt-12 text-[3rem] xl:text-[5rem] text-">
        Contact Us
      </h1>
      ...
      <div className="container grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-2 p-5 mt-5">
        <div className=" float-right">
          <h1 className="text-[2rem] text-black m-5 text-center">
            Online Inquiry
          </h1>
          <ContactForm text={""} />
        </div>
        <div className="justify-center xl:justify-end lg:justify-center md:justify-center flex text-theme-500 w-full">
          <ul className="m-5">
            <h1 className="text-[2rem] mb-5 text-center">Contact Details</h1>
